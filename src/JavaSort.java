...
public class JavaSort {
	...
	// Complete the code
	// created new class "CompareData" to avoid code complexity
	...
	public static void main(String[] args) {
		...
		// called Collections.sort method to sort the studentList and created the object
		// of CompareData class.
